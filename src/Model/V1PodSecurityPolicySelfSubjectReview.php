...
/**
 * V1PodSecurityPolicySelfSubjectReview Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PodSecurityPolicySelfSubjectReview implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.PodSecurityPolicySelfSubjectReview';
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'kind' => 'string',
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySelfSubjectReviewSpec',
        'status' => '\UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySubjectReviewStatus'
    ];
    ...
    /**
     * Gets spec
     * @return \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySelfSubjectReviewSpec
     */
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySelfSubjectReviewSpec $spec spec defines specification the PodSecurityPolicySelfSubjectReview.
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySubjectReviewStatus
     */
    ...
    /**
     * Sets status
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySubjectReviewStatus $status status represents the current information/status for the PodSecurityPolicySelfSubjectReview.
     * @return $this
     */
