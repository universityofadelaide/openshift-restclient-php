...
/**
 * V1OAuthAuthorizeTokenList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1OAuthAuthorizeTokenList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.OAuthAuthorizeTokenList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1OAuthAuthorizeToken[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1OAuthAuthorizeToken[] $items Items is the list of OAuth authorization tokens
     * @return $this
     */
