...
/**
 * V1TemplateList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1TemplateList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.TemplateList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1Template[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Template[] $items Items is a list of templates
     * @return $this
     */
