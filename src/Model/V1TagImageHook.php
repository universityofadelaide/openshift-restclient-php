...
/**
 * V1TagImageHook Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1TagImageHook implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.TagImageHook';
    ...
    /**
     * Sets to
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ObjectReference $to To is the target ImageStreamTag to set the container's image onto.
     * @return $this
     */
