 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1NetworkPolicyList implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1beta1NetworkPolicy[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1NetworkPolicy[] $items Items is a list of schema objects.
     * @return $this
     */
