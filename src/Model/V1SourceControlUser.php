...
/**
 * V1SourceControlUser Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1SourceControlUser implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.SourceControlUser';
    ...
    /**
     * Sets email
     * @param string $email email of the source control user
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name name of the source control user
     * @return $this
     */
