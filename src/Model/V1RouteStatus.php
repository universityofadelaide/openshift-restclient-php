...
/**
 * V1RouteStatus Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1RouteStatus implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.RouteStatus';
    ...
    protected static $swaggerTypes = [
        'ingress' => '\UniversityOfAdelaide\OpenShift\Model\V1RouteIngress[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ingress'] === null) {
            $invalid_properties[] = "'ingress' can't be null";
        }
    ...
    /**
     * Gets ingress
     * @return \UniversityOfAdelaide\OpenShift\Model\V1RouteIngress[]
     */
    ...
    /**
     * Sets ingress
     * @param \UniversityOfAdelaide\OpenShift\Model\V1RouteIngress[] $ingress ingress describes the places where the route may be exposed. The list of ingress points may contain duplicate Host or RouterName values. Routes are considered live once they are `Ready`
     * @return $this
     */
