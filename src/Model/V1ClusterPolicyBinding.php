...
class V1ClusterPolicyBinding implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'roleBindings' => '\UniversityOfAdelaide\OpenShift\Model\V1NamedClusterRoleBinding[]'
    ];
    ...
    /**
     * Sets lastModified
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Time $lastModified LastModified is the last time that any part of the ClusterPolicyBinding was created, updated, or deleted
     * @return $this
     */
    ...
    /**
     * Sets policyRef
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ObjectReference $policyRef PolicyRef is a reference to the ClusterPolicy that contains all the ClusterRoles that this ClusterPolicyBinding's RoleBindings may reference
     * @return $this
     */
    ...
    /**
     * Sets roleBindings
     * @param \UniversityOfAdelaide\OpenShift\Model\V1NamedClusterRoleBinding[] $roleBindings RoleBindings holds all the ClusterRoleBindings held by this ClusterPolicyBinding, mapped by ClusterRoleBinding.Name
     * @return $this
     */
