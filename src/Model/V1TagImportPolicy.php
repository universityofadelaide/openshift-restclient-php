...
/**
 * V1TagImportPolicy Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1TagImportPolicy implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.TagImportPolicy';
    ...
    /**
     * Sets insecure
     * @param bool $insecure Insecure is true if the server may bypass certificate verification or connect directly over HTTP during image import.
     * @return $this
     */
    ...
    /**
     * Sets scheduled
     * @param bool $scheduled Scheduled indicates to the server that this tag should be periodically checked to ensure it is up to date, and imported
     * @return $this
     */
