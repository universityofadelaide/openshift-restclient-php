...
/**
 * V1beta1PodSecurityPolicyList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1PodSecurityPolicyList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.PodSecurityPolicyList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1beta1PodSecurityPolicy[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1PodSecurityPolicy[] $items Items is a list of schema objects.
     * @return $this
     */
    ...
    /**
     * Sets metadata
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ListMeta $metadata Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata
     * @return $this
     */
