...
/**
 * V1LocalSubjectAccessReview Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1LocalSubjectAccessReview implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.LocalSubjectAccessReview';
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V1SubjectAccessReviewSpec',
        'status' => '\UniversityOfAdelaide\OpenShift\Model\V1SubjectAccessReviewStatus'
    ];
    ...
    /**
     * Gets spec
     * @return \UniversityOfAdelaide\OpenShift\Model\V1SubjectAccessReviewSpec
     */
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V1SubjectAccessReviewSpec $spec Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \UniversityOfAdelaide\OpenShift\Model\V1SubjectAccessReviewStatus
     */
    ...
    /**
     * Sets status
     * @param \UniversityOfAdelaide\OpenShift\Model\V1SubjectAccessReviewStatus $status Status is filled in by the server and indicates whether the request is allowed or not
     * @return $this
     */
