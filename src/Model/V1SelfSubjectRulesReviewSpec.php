...
/**
 * V1SelfSubjectRulesReviewSpec Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1SelfSubjectRulesReviewSpec implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.SelfSubjectRulesReviewSpec';
    ...
    /**
     * Sets scopes
     * @param string[] $scopes Scopes to use for the evaluation.  Empty means \"use the unscoped (full) permissions of the user/groups\". Nil means \"use the scopes on this request\".
     * @return $this
     */
