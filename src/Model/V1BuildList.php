 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1BuildList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.BuildList';
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1Build[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Build[] $items items is a list of builds
     * @return $this
     */
    ...
    /**
     * Sets metadata
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ListMeta $metadata metadata for BuildList.
     * @return $this
     */
