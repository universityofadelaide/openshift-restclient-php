 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PersistentVolumeClaimStatus implements ArrayAccess
{
    ...
    /**
     * Sets capacity
     * @param map[string,\UniversityOfAdelaide\OpenShift\Model\ResourceQuantity] $capacity Represents the actual resources of the underlying volume.
     * @return $this
     */
