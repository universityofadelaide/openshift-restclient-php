...
/**
 * V1OAuthAuthorizeToken Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1OAuthAuthorizeToken implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.OAuthAuthorizeToken';
    ...
    /**
     * Sets state
     * @param string $state State data from request
     * @return $this
     */
