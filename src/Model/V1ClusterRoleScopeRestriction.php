...
/**
 * V1ClusterRoleScopeRestriction Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ClusterRoleScopeRestriction implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ClusterRoleScopeRestriction';
    ...
    /**
     * Sets namespaces
     * @param string[] $namespaces Namespaces is the list of namespaces that can be referenced.  * means any of them (including *)
     * @return $this
     */
