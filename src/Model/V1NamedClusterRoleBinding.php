...
/**
 * V1NamedClusterRoleBinding Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1NamedClusterRoleBinding implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.NamedClusterRoleBinding';
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'role_binding' => '\UniversityOfAdelaide\OpenShift\Model\V1ClusterRoleBinding'
    ];
    ...
    /**
     * Sets name
     * @param string $name Name is the name of the cluster role binding
     * @return $this
     */
    ...
    /**
     * Sets role_binding
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ClusterRoleBinding $role_binding RoleBinding is the cluster role binding being named
     * @return $this
     */
