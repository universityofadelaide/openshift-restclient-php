 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ReplicaSetSpec implements ArrayAccess
{
    ...
    /**
     * Sets replicas
     * @param int $replicas Replicas is the number of desired replicas. This is a pointer to distinguish between explicit zero and unspecified. Defaults to 1. More info: http://kubernetes.io/docs/user-guide/replication-controller#what-is-a-replication-controller
     * @return $this
     */
    ...
    /**
     * Sets selector
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LabelSelector $selector Selector is a label query over pods that should match the replica count. If the selector is empty, it is defaulted to the labels present on the pod template. Label keys and values that must match in order to be controlled by this replica set. More info: http://kubernetes.io/docs/user-guide/labels#label-selectors
     * @return $this
     */
    ...
    /**
     * Sets template
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodTemplateSpec $template Template is the object that describes the pod that will be created if insufficient replicas are detected. More info: http://kubernetes.io/docs/user-guide/replication-controller#pod-template
     * @return $this
     */
