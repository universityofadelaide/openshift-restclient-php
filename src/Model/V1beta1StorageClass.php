...
/**
 * V1beta1StorageClass Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1StorageClass implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.StorageClass';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['provisioner'] === null) {
            $invalid_properties[] = "'provisioner' can't be null";
        }
    ...
    /**
     * Sets parameters
     * @param map[string,string] $parameters Parameters holds the parameters for the provisioner that should create volumes of this storage class.
     * @return $this
     */
