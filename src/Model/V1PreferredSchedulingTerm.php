 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PreferredSchedulingTerm implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'preference' => '\UniversityOfAdelaide\OpenShift\Model\V1NodeSelectorTerm',
        'weight' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['preference'] === null) {
            $invalid_properties[] = "'preference' can't be null";
        }
    ...
    /**
     * Sets preference
     * @param \UniversityOfAdelaide\OpenShift\Model\V1NodeSelectorTerm $preference A node selector term, associated with the corresponding weight.
     * @return $this
     */
