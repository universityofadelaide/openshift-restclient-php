...
/**
 * V1DeploymentConfigSpec Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1DeploymentConfigSpec implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.DeploymentConfigSpec';
    ...
    protected static $swaggerTypes = [
        ...
        'test' => 'bool',
        'triggers' => '\UniversityOfAdelaide\OpenShift\Model\V1DeploymentTriggerPolicy[]'
    ];
    ...
    /**
     * Sets paused
     * @param bool $paused Paused indicates that the deployment config is paused resulting in no new deployments on template changes or changes in the template caused by other triggers.
     * @return $this
     */
    ...
    /**
     * Sets replicas
     * @param int $replicas Replicas is the number of desired replicas.
     * @return $this
     */
    ...
    /**
     * Sets selector
     * @param map[string,string] $selector Selector is a label query over pods that should match the Replicas count.
     * @return $this
     */
    ...
    /**
     * Gets strategy
     * @return \UniversityOfAdelaide\OpenShift\Model\V1DeploymentStrategy
     */
    ...
    /**
     * Sets strategy
     * @param \UniversityOfAdelaide\OpenShift\Model\V1DeploymentStrategy $strategy Strategy describes how a deployment is executed.
     * @return $this
     */
    ...
    /**
     * Sets template
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodTemplateSpec $template Template is the object that describes the pod that will be created if insufficient replicas are detected.
     * @return $this
     */
    ...
    /**
     * Sets test
     * @param bool $test Test ensures that this deployment config will have zero replicas except while a deployment is running. This allows the deployment config to be used as a continuous deployment test - triggering on images, running the deployment, and then succeeding or failing. Post strategy hooks and After actions can be used to integrate successful deployment with an action.
     * @return $this
     */
    ...
    /**
     * Gets triggers
     * @return \UniversityOfAdelaide\OpenShift\Model\V1DeploymentTriggerPolicy[]
     */
