...
/**
 * V1PodTemplate Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PodTemplate implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.PodTemplate';
    ...
    /**
     * Sets template
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodTemplateSpec $template Template defines the pods that will be created from this pod template. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
