...
/**
 * V1ProjectSpec Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ProjectSpec implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ProjectSpec';
    ...
    /**
     * Sets finalizers
     * @param string[] $finalizers Finalizers is an opaque list of values that must be empty to permanently remove object from storage
     * @return $this
     */
