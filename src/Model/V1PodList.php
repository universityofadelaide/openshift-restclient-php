 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PodList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.PodList';
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1Pod[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Pod[] $items List of pods. More info: http://kubernetes.io/docs/user-guide/pods
     * @return $this
     */
