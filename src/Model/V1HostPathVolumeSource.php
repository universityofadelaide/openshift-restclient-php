...
/**
 * V1HostPathVolumeSource Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1HostPathVolumeSource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.HostPathVolumeSource';
    ...
    /**
     * Sets path
     * @param string $path Path of the directory on the host. More info: http://kubernetes.io/docs/user-guide/volumes#hostpath
     * @return $this
     */
