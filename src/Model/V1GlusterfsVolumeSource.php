...
/**
 * V1GlusterfsVolumeSource Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1GlusterfsVolumeSource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.GlusterfsVolumeSource';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['endpoints'] === null) {
            $invalid_properties[] = "'endpoints' can't be null";
        }
    ...
    /**
     * Sets endpoints
     * @param string $endpoints EndpointsName is the endpoint name that details Glusterfs topology. More info: http://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md#create-a-pod
     * @return $this
     */
    ...
    /**
     * Sets path
     * @param string $path Path is the Glusterfs volume path. More info: http://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md#create-a-pod
     * @return $this
     */
