...
/**
 * V1HorizontalPodAutoscalerList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1HorizontalPodAutoscalerList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.HorizontalPodAutoscalerList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1HorizontalPodAutoscaler[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1HorizontalPodAutoscaler[] $items list of horizontal pod autoscaler objects.
     * @return $this
     */
