...
/**
 * V1RouteTargetReference Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1RouteTargetReference implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.RouteTargetReference';
    ...
    /**
     * Sets kind
     * @param string $kind The kind of target that the route is referring to. Currently, only 'Service' is allowed
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name name of the service/target that is being referred to. e.g. name of the service
     * @return $this
     */
    ...
    /**
     * Sets weight
     * @param int $weight weight as an integer between 1 and 256 that specifies the target's relative weight against other target reference objects
     * @return $this
     */
