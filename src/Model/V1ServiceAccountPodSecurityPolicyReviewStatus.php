...
/**
 * V1ServiceAccountPodSecurityPolicyReviewStatus Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ServiceAccountPodSecurityPolicyReviewStatus implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ServiceAccountPodSecurityPolicyReviewStatus';
    ...
    /**
     * Sets name
     * @param string $name name contains the allowed and the denied ServiceAccount name
     * @return $this
     */
    ...
    /**
     * Sets reason
     * @param string $reason A machine-readable description of why this operation is in the \"Failure\" status. If this value is empty there is no information available.
     * @return $this
     */
    ...
    /**
     * Sets template
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodTemplateSpec $template template is the PodTemplateSpec after the defaulting is applied.
     * @return $this
     */
