...
/**
 * V1NetNamespace Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1NetNamespace implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.NetNamespace';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['netname'] = isset($data['netname']) ? $data['netname'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['netid'] === null) {
            $invalid_properties[] = "'netid' can't be null";
        }
        if ($this->container['netname'] === null) {
            $invalid_properties[] = "'netname' can't be null";
        }
    ...
    /**
     * Sets netid
     * @param int $netid NetID is the network identifier of the network namespace assigned to each overlay network packet. This can be manipulated with the \"oadm pod-network\" commands.
     * @return $this
     */
    ...
    /**
     * Sets netname
     * @param string $netname NetName is the name of the network namespace. (This is the same as the object's name, but both fields must be set.)
     * @return $this
     */
