 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1StatusDetails implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'causes' => '\UniversityOfAdelaide\OpenShift\Model\V1StatusCause[]',
        'group' => 'string',
        'kind' => 'string',
        'name' => 'string',
    ...
    /**
     * Gets causes
     * @return \UniversityOfAdelaide\OpenShift\Model\V1StatusCause[]
     */
    ...
    /**
     * Sets causes
     * @param \UniversityOfAdelaide\OpenShift\Model\V1StatusCause[] $causes The Causes array includes more details associated with the StatusReason failure. Not all StatusReasons may provide detailed causes.
     * @return $this
     */
    ...
    /**
     * Sets kind
     * @param string $kind The kind attribute of the resource associated with the status StatusReason. On some operations may differ from the requested resource Kind. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds
     * @return $this
     */
