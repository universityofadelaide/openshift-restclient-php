...
/**
 * V1JenkinsPipelineBuildStrategy Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1JenkinsPipelineBuildStrategy implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.JenkinsPipelineBuildStrategy';
    ...
    /**
     * Sets env
     * @param \UniversityOfAdelaide\OpenShift\Model\V1EnvVar[] $env env contains additional environment variables you want to pass into a build pipeline. ValueFrom is not supported.
     * @return $this
     */
    ...
    {
        return $this->container['jenkinsfile'];
    }

    /**
     * Sets jenkinsfile
     * @param string $jenkinsfile Jenkinsfile defines the optional raw contents of a Jenkinsfile which defines a Jenkins pipeline build.
     * @return $this
     */
    public function setJenkinsfile($jenkinsfile)
    {
        $this->container['jenkinsfile'] = $jenkinsfile;
