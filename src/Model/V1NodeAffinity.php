...
class V1NodeAffinity implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'requiredDuringSchedulingIgnoredDuringExecution' => '\UniversityOfAdelaide\OpenShift\Model\V1NodeSelector'
    ];
     ...
     * @param \UniversityOfAdelaide\OpenShift\Model\V1NodeSelector $requiredDuringSchedulingIgnoredDuringExecution If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to an update), the system may or may not try to eventually evict the pod from its node.
     * @return $this
     */
