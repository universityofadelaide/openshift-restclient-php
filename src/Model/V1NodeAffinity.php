...
/**
 * V1NodeAffinity Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1NodeAffinity implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.NodeAffinity';
    ...
    protected static $swaggerTypes = [
        'preferred_during_scheduling_ignored_during_execution' => '\UniversityOfAdelaide\OpenShift\Model\V1PreferredSchedulingTerm[]',
        'required_during_scheduling_ignored_during_execution' => '\UniversityOfAdelaide\OpenShift\Model\V1NodeSelector'
    ];
     ...
     * @return \UniversityOfAdelaide\OpenShift\Model\V1PreferredSchedulingTerm[]
     */
     ...
     * @return \UniversityOfAdelaide\OpenShift\Model\V1NodeSelector
     */
     ...
     * @param \UniversityOfAdelaide\OpenShift\Model\V1NodeSelector $required_during_scheduling_ignored_during_execution If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to an update), the system may or may not try to eventually evict the pod from its node.
     * @return $this
     */
