...
/**
 * V1OAuthAccessTokenList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1OAuthAccessTokenList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.OAuthAccessTokenList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1OAuthAccessToken[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1OAuthAccessToken[] $items Items is the list of OAuth access tokens
     * @return $this
     */
