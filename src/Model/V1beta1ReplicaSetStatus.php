 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ReplicaSetStatus implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'conditions' => '\UniversityOfAdelaide\OpenShift\Model\V1beta1ReplicaSetCondition[]',
     ...
     * @param int $availableReplicas The number of available replicas (ready for at least minReadySeconds) for this replica set.
     * @return $this
     */
    ...
    /**
     * Gets conditions
     * @return \UniversityOfAdelaide\OpenShift\Model\V1beta1ReplicaSetCondition[]
     */
    ...
    /**
     * Sets conditions
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1ReplicaSetCondition[] $conditions Represents the latest available observations of a replica set's current state.
     * @return $this
     */
     ...
     * @param int $fullyLabeledReplicas The number of pods that have labels matching the labels of the pod template of the replicaset.
     * @return $this
     */
     ...
     * @param int $observedGeneration ObservedGeneration reflects the generation of the most recently observed ReplicaSet.
     * @return $this
     */
    ...
    /**
     * Sets readyReplicas
     * @param int $readyReplicas The number of ready replicas for this replica set.
     * @return $this
     */
