...
/**
 * V1beta1RunAsUserStrategyOptions Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1RunAsUserStrategyOptions implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.RunAsUserStrategyOptions';
    ...
    /**
     * Sets ranges
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1IDRange[] $ranges Ranges are the allowed ranges of uids that may be used.
     * @return $this
     */
    ...
    /**
     * Sets rule
     * @param string $rule Rule is the strategy that will dictate the allowable RunAsUser values that may be set.
     * @return $this
     */
