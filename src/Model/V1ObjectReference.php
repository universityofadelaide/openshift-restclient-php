 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ObjectReference implements ArrayAccess
{
    ...
    /**
     * Sets namespace
     * @param string $namespace Namespace of the referent. More info: http://kubernetes.io/docs/user-guide/namespaces
     * @return $this
     */
