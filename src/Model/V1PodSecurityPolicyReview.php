...
/**
 * V1PodSecurityPolicyReview Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PodSecurityPolicyReview implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.PodSecurityPolicyReview';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'kind' => 'string',
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicyReviewSpec',
        'status' => '\UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicyReviewStatus'
    ];
    ...
    /**
     * Gets spec
     * @return \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicyReviewSpec
     */
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicyReviewSpec $spec spec is the PodSecurityPolicy to check.
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicyReviewStatus
     */
    ...
    /**
     * Sets status
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicyReviewStatus $status status represents the current information/status for the PodSecurityPolicyReview.
     * @return $this
     */
