...
/**
 * V2alpha1CronJobStatus Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2alpha1CronJobStatus implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2alpha1.CronJobStatus';
    ...
    /**
     * Sets active
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ObjectReference[] $active Active holds pointers to currently running jobs.
     * @return $this
     */
