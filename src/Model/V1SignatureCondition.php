...
/**
 * V1SignatureCondition Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1SignatureCondition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.SignatureCondition';
     ...
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Time $last_probe_time Last time the condition was checked.
     * @return $this
     */
    ...
    /**
     * Sets reason
     * @param string $reason (brief) reason for the condition's last transition.
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type Type of signature condition, Complete or Failed.
     * @return $this
     */
