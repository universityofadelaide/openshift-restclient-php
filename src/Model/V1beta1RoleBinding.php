...
class V1beta1RoleBinding implements ArrayAccess
{
    ...
    /**
     * Sets roleRef
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1RoleRef $roleRef RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
     * @return $this
     */
