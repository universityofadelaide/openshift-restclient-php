...
/**
 * V1beta1RoleBinding Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1RoleBinding implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.RoleBinding';
    ...
    /**
     * Sets role_ref
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1RoleRef $role_ref RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
     * @return $this
     */
    ...
    /**
     * Gets subjects
     * @return \UniversityOfAdelaide\OpenShift\Model\V1beta1Subject[]
     */
    ...
    /**
     * Sets subjects
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1Subject[] $subjects Subjects holds references to the objects the role applies to.
     * @return $this
     */
