...
class V1beta1DeploymentSpec implements ArrayAccess
{
     ...
     * @param int $revisionHistoryLimit The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified.
     * @return $this
     */
    ...
    /**
     * Sets rollbackTo
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1RollbackConfig $rollbackTo The config this deployment is rolling back to. Will be cleared after rollback is done.
     * @return $this
     */
