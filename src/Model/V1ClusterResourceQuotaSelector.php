...
/**
 * V1ClusterResourceQuotaSelector Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ClusterResourceQuotaSelector implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ClusterResourceQuotaSelector';
    ...
    /**
     * Sets annotations
     * @param map[string,string] $annotations AnnotationSelector is used to select projects by annotation.
     * @return $this
     */
    ...
    /**
     * Sets labels
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LabelSelector $labels LabelSelector is used to select projects by label.
     * @return $this
     */
