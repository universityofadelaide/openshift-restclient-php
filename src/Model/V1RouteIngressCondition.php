...
/**
 * V1RouteIngressCondition Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1RouteIngressCondition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.RouteIngressCondition';
    ...
    /**
     * Sets reason
     * @param string $reason (brief) reason for the condition's last transition, and is usually a machine and human readable constant
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type Type is the type of the condition. Currently only Ready.
     * @return $this
     */
