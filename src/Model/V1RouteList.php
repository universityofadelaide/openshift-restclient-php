 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1RouteList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.RouteList';
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1Route[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Route[] $items items is a list of routes
     * @return $this
     */
    ...
    /**
     * Sets metadata
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ListMeta $metadata Standard object metadata.
     * @return $this
     */
