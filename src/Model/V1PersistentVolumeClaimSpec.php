 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PersistentVolumeClaimSpec implements ArrayAccess
{
    ...
    /**
     * Sets resources
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ResourceRequirements $resources Resources represents the minimum resources the volume should have. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#resources
     * @return $this
     */
    ...
    /**
     * Sets selector
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LabelSelector $selector A label query over volumes to consider for binding.
     * @return $this
     */
