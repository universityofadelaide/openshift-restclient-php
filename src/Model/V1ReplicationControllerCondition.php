...
/**
 * V1ReplicationControllerCondition Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ReplicationControllerCondition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ReplicationControllerCondition';
     ...
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Time $last_transition_time The last time the condition transitioned from one status to another.
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type Type of replication controller condition.
     * @return $this
     */
