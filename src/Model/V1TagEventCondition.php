...
/**
 * V1TagEventCondition Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1TagEventCondition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.TagEventCondition';
    ...
    /**
     * Sets generation
     * @param int $generation Generation is the spec tag generation that this status corresponds to
     * @return $this
     */
     ...
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Time $last_transition_time LastTransitionTIme is the time the condition transitioned from one status to another.
     * @return $this
     */
    ...
    /**
     * Sets message
     * @param string $message Message is a human readable description of the details about last transition, complementing reason.
     * @return $this
     */
    ...
    /**
     * Sets reason
     * @param string $reason Reason is a brief machine readable explanation for the condition's last transition.
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type Type of tag event condition, currently only ImportSuccess
     * @return $this
     */
