...
/**
 * V1ImageLabel Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ImageLabel implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ImageLabel';
    ...
    /**
     * Sets name
     * @param string $name name defines the name of the label. It must have non-zero length.
     * @return $this
     */
    ...
    /**
     * Sets value
     * @param string $value value defines the literal value of the label.
     * @return $this
     */
