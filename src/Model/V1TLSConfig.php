 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1TLSConfig implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.TLSConfig';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['termination'] === null) {
            $invalid_properties[] = "'termination' can't be null";
        }
    ...
    /**
     * Sets certificate
     * @param string $certificate certificate provides certificate contents
     * @return $this
     */
    ...
    /**
     * Sets key
     * @param string $key key provides key file contents
     * @return $this
     */
    ...
    /**
     * Sets termination
     * @param string $termination termination indicates termination type.
     * @return $this
     */
