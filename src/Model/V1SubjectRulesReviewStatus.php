...
/**
 * V1SubjectRulesReviewStatus Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1SubjectRulesReviewStatus implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.SubjectRulesReviewStatus';
    ...
    /**
     * Gets rules
     * @return \UniversityOfAdelaide\OpenShift\Model\V1PolicyRule[]
     */
    ...
    /**
     * Sets rules
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PolicyRule[] $rules Rules is the list of rules (no particular sort) that are allowed for the subject
     * @return $this
     */
