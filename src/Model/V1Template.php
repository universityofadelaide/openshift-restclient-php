 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1Template implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.Template';
    ...
    protected static $swaggerTypes = [
        ...
        'objects' => '\UniversityOfAdelaide\OpenShift\Model\RuntimeRawExtension[]',
        'parameters' => '\UniversityOfAdelaide\OpenShift\Model\V1Parameter[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['objects'] === null) {
            $invalid_properties[] = "'objects' can't be null";
        }
    ...
    /**
     * Sets labels
     * @param map[string,string] $labels labels is a optional set of labels that are applied to every object during the Template to Config transformation.
     * @return $this
     */
    ...
    /**
     * Sets message
     * @param string $message message is an optional instructional message that will be displayed when this template is instantiated. This field should inform the user how to utilize the newly created resources. Parameter substitution will be performed on the message before being displayed so that generated credentials and other parameters can be included in the output.
     * @return $this
     */
    ...
    /**
     * Gets parameters
     * @return \UniversityOfAdelaide\OpenShift\Model\V1Parameter[]
     */
    ...
    /**
     * Sets parameters
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Parameter[] $parameters parameters is an optional array of Parameters used during the Template to Config transformation.
     * @return $this
     */
