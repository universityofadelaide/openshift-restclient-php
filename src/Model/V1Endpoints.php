 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1Endpoints implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.Endpoints';
    ...
    protected static $swaggerTypes = [
        ...
        'subsets' => '\UniversityOfAdelaide\OpenShift\Model\V1EndpointSubset[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subsets'] === null) {
            $invalid_properties[] = "'subsets' can't be null";
        }
    ...
    /**
     * Gets subsets
     * @return \UniversityOfAdelaide\OpenShift\Model\V1EndpointSubset[]
     */
    ...
    /**
     * Sets subsets
     * @param \UniversityOfAdelaide\OpenShift\Model\V1EndpointSubset[] $subsets The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.
     * @return $this
     */
