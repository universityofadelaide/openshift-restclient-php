...
/**
 * V1ComponentCondition Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ComponentCondition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ComponentCondition';
    ...
    /**
     * Sets error
     * @param string $error Condition error code for a component. For example, a health check error code.
     * @return $this
     */
    ...
    /**
     * Sets message
     * @param string $message Message about the condition for a component. For example, information about a health check.
     * @return $this
     */
