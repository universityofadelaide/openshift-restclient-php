...
/**
 * V1UserRestriction Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1UserRestriction implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.UserRestriction';
    ...
    /**
     * Sets groups
     * @param string[] $groups Groups specifies a list of literal group names.
     * @return $this
     */
    ...
    /**
     * Sets labels
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LabelSelector[] $labels Selectors specifies a list of label selectors over user labels.
     * @return $this
     */
    ...
    /**
     * Sets users
     * @param string[] $users Users specifies a list of literal user names.
     * @return $this
     */
