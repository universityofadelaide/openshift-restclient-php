...
/**
 * V1beta1SELinuxStrategyOptions Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1SELinuxStrategyOptions implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.SELinuxStrategyOptions';
    ...
    /**
     * Sets rule
     * @param string $rule type is the strategy that will dictate the allowable labels that may be set.
     * @return $this
     */
