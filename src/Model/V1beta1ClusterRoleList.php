...
/**
 * V1beta1ClusterRoleList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ClusterRoleList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.ClusterRoleList';
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1beta1ClusterRole[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1ClusterRole[] $items Items is a list of ClusterRoles
     * @return $this
     */
