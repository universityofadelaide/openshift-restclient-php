...
/**
 * V1ImageImportSpec Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ImageImportSpec implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ImageImportSpec';
    ...
    protected static $swaggerTypes = [
        ...
        'to' => '\UniversityOfAdelaide\OpenShift\Model\V1LocalObjectReference'
    ];
    ...
    /**
     * Sets from
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ObjectReference $from From is the source of an image to import; only kind DockerImage is allowed
     * @return $this
     */
    ...
    /**
     * Sets to
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LocalObjectReference $to To is a tag in the current image stream to assign the imported image to, if name is not specified the default tag from from.name will be used
     * @return $this
     */
