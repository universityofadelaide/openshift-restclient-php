...
/**
 * V1DeploymentCause Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1DeploymentCause implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.DeploymentCause';
    ...
    /**
     * Sets type
     * @param string $type Type of the trigger that resulted in the creation of a new deployment
     * @return $this
     */
