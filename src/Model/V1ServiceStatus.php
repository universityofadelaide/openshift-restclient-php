...
class V1ServiceStatus implements ArrayAccess
{
    ...
    /**
     * Sets loadBalancer
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LoadBalancerStatus $loadBalancer LoadBalancer contains the current status of the load-balancer, if one is present.
     * @return $this
     */
