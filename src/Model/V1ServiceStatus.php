...
/**
 * V1ServiceStatus Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ServiceStatus implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ServiceStatus';
    ...
    /**
     * Sets load_balancer
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LoadBalancerStatus $load_balancer LoadBalancer contains the current status of the load-balancer, if one is present.
     * @return $this
     */
