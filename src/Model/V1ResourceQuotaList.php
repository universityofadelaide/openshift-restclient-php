...
/**
 * V1ResourceQuotaList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ResourceQuotaList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ResourceQuotaList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1ResourceQuota[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ResourceQuota[] $items Items is a list of ResourceQuota objects. More info: http://releases.k8s.io/HEAD/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota
     * @return $this
     */
