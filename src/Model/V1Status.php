 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1Status implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'kind' => 'string',
        'message' => 'string',
        'metadata' => '\UniversityOfAdelaide\OpenShift\Model\V1ListMeta',
        'reason' => 'string',
        'status' => 'string'
    ];
    ...
    /**
     * Gets details
     * @return \UniversityOfAdelaide\OpenShift\Model\V1StatusDetails
     */
    ...
    /**
     * Sets details
     * @param \UniversityOfAdelaide\OpenShift\Model\V1StatusDetails $details Extended data associated with the reason.  Each reason may define its own extended details. This field is optional and the data returned is not guaranteed to conform to any schema except that defined by the reason type.
     * @return $this
     */
    ...
    /**
     * Gets metadata
     * @return \UniversityOfAdelaide\OpenShift\Model\V1ListMeta
     */
    ...
    /**
     * Sets metadata
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ListMeta $metadata Standard list metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param string $status Status of the operation. One of: \"Success\" or \"Failure\". More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
