...
/**
 * V1beta1RollbackConfig Class Doc Comment
 *
 * @category    Class
 * @package     UniversityOfAdelaide\OpenShift
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1RollbackConfig implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.RollbackConfig';
    ...
    /**
     * Sets revision
     * @param int $revision The revision to rollback to. If set to 0, rollbck to the last revision.
     * @return $this
     */
