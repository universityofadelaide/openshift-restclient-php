...
/**
 * V1AppliedClusterResourceQuotaList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1AppliedClusterResourceQuotaList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.AppliedClusterResourceQuotaList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1AppliedClusterResourceQuota[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1AppliedClusterResourceQuota[] $items Items is a list of AppliedClusterResourceQuota
     * @return $this
     */
