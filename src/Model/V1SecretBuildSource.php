...
/**
 * V1SecretBuildSource Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1SecretBuildSource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.SecretBuildSource';
    ...
    /**
     * Sets secret
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LocalObjectReference $secret secret is a reference to an existing secret that you want to use in your build.
     * @return $this
     */
