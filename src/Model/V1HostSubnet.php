...
/**
 * V1HostSubnet Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1HostSubnet implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.HostSubnet';
    ...
    /**
     * Sets host
     * @param string $host Host is the name of the node. (This is the same as the object's name, but both fields must be set.)
     * @return $this
     */
    ...
    /**
     * Sets subnet
     * @param string $subnet Subnet is the CIDR range of the overlay network assigned to the node for its pods
     * @return $this
     */
