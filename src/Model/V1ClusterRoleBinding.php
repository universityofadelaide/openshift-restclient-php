...
class V1ClusterRoleBinding implements ArrayAccess
{
    ...
    /**
     * Sets roleRef
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ObjectReference $roleRef RoleRef can only reference the current namespace and the global namespace. If the ClusterRoleRef cannot be resolved, the Authorizer must return an error. Since Policy is a singleton, this is sufficient knowledge to locate a role.
     * @return $this
     */
