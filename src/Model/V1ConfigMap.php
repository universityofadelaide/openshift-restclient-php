 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ConfigMap implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ConfigMap';
    ...
    /**
     * Sets data
     * @param map[string,string] $data Data contains the configuration data. Each key must be a valid DNS_SUBDOMAIN with an optional leading dot.
     * @return $this
     */
