...
/**
 * V1ServiceAccount Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ServiceAccount implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ServiceAccount';
    ...
    /**
     * Sets secrets
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ObjectReference[] $secrets Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. More info: http://kubernetes.io/docs/user-guide/secrets
     * @return $this
     */
