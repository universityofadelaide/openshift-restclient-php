...
/**
 * V1PodSecurityPolicySubjectReview Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1PodSecurityPolicySubjectReview implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.PodSecurityPolicySubjectReview';
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'kind' => 'string',
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySubjectReviewSpec',
    ...
    /**
     * Gets spec
     * @return \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySubjectReviewSpec
     */
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySubjectReviewSpec $spec spec defines specification for the PodSecurityPolicySubjectReview.
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param \UniversityOfAdelaide\OpenShift\Model\V1PodSecurityPolicySubjectReviewStatus $status status represents the current information/status for the PodSecurityPolicySubjectReview.
     * @return $this
     */
