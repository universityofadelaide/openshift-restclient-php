 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1User implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.User';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['identities'] === null) {
            $invalid_properties[] = "'identities' can't be null";
        }
    ...
    /**
     * Sets groups
     * @param string[] $groups Groups specifies group names this user is a member of. This field is deprecated and will be removed in a future release. Instead, create a Group object containing the name of this User.
     * @return $this
     */
    ...
    /**
     * Sets identities
     * @param string[] $identities Identities are the identities associated with this user
     * @return $this
     */
