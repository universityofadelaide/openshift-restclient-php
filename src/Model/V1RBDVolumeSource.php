 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1RBDVolumeSource implements ArrayAccess
{
    ...
    /**
     * Sets image
     * @param string $image The rados image name. More info: http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
     * @return $this
     */
    ...
    /**
     * Sets keyring
     * @param string $keyring Keyring is the path to key ring for RBDUser. Default is /etc/ceph/keyring. More info: http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
     * @return $this
     */
    ...
    /**
     * Sets monitors
     * @param string[] $monitors A collection of Ceph monitors. More info: http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
     * @return $this
     */
    ...
    /**
     * Sets pool
     * @param string $pool The rados pool name. Default is rbd. More info: http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it.
     * @return $this
     */
    ...
    /**
     * Sets user
     * @param string $user The rados user name. Default is admin. More info: http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
     * @return $this
     */
