...
/**
 * V1ResourceQuota Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1ResourceQuota implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.ResourceQuota';
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V1ResourceQuotaSpec',
        'status' => '\UniversityOfAdelaide\OpenShift\Model\V1ResourceQuotaStatus'
    ];
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ResourceQuotaSpec $spec Spec defines the desired quota. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \UniversityOfAdelaide\OpenShift\Model\V1ResourceQuotaStatus
     */
    ...
    /**
     * Sets status
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ResourceQuotaStatus $status Status defines the actual enforced quota and its current usage. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
