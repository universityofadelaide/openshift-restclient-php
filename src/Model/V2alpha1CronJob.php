...
/**
 * V2alpha1CronJob Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2alpha1CronJob implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2alpha1.CronJob';
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V2alpha1CronJobSpec',
        'status' => '\UniversityOfAdelaide\OpenShift\Model\V2alpha1CronJobStatus'
    ];
    ...
    /**
     * Gets spec
     * @return \UniversityOfAdelaide\OpenShift\Model\V2alpha1CronJobSpec
     */
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V2alpha1CronJobSpec $spec Spec is a structure defining the expected behavior of a job, including the schedule. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \UniversityOfAdelaide\OpenShift\Model\V2alpha1CronJobStatus
     */
    ...
    /**
     * Sets status
     * @param \UniversityOfAdelaide\OpenShift\Model\V2alpha1CronJobStatus $status Status is a structure describing current status of a job. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
