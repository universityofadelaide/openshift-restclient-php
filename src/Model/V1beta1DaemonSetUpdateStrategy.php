...
/**
 * V1beta1DaemonSetUpdateStrategy Class Doc Comment
 *
 * @category    Class
 * @package     UniversityOfAdelaide\OpenShift
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1DaemonSetUpdateStrategy implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.DaemonSetUpdateStrategy';
    ...
    protected static $swaggerTypes = [
        'rolling_update' => '\UniversityOfAdelaide\OpenShift\Model\V1beta1RollingUpdateDaemonSet',
        'type' => 'string'
    ];
    ...
    /**
     * Gets rolling_update
     * @return \UniversityOfAdelaide\OpenShift\Model\V1beta1RollingUpdateDaemonSet
     */
    ...
    /**
     * Sets rolling_update
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1RollingUpdateDaemonSet $rolling_update Rolling update config params. Present only if type = \"RollingUpdate\".
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type Type of daemon set update. Can be \"RollingUpdate\" or \"OnDelete\". Default is OnDelete.
     * @return $this
     */
