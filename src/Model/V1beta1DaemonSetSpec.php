 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1DaemonSetSpec implements ArrayAccess
{
    ...
    /**
     * Sets selector
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LabelSelector $selector A label query over pods that are managed by the daemon set. Must match in order to be controlled. If empty, defaulted to labels on Pod template. More info: http://kubernetes.io/docs/user-guide/labels#label-selectors
     * @return $this
     */
