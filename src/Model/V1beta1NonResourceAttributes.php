...
/**
 * V1beta1NonResourceAttributes Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1NonResourceAttributes implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.NonResourceAttributes';
    ...
    /**
     * Sets path
     * @param string $path Path is the URL path of the request
     * @return $this
     */
    ...
    /**
     * Sets verb
     * @param string $verb Verb is the standard HTTP verb
     * @return $this
     */
