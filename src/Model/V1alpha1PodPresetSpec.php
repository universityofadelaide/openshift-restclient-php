 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1PodPresetSpec implements ArrayAccess
{
    ...
    /**
     * Sets env
     * @param \UniversityOfAdelaide\OpenShift\Model\V1EnvVar[] $env Env defines the collection of EnvVar to inject into containers.
     * @return $this
     */
    ...
    /**
     * Sets selector
     * @param \UniversityOfAdelaide\OpenShift\Model\V1LabelSelector $selector Selector is a label query over a set of resources, in this case pods. Required.
     * @return $this
     */
    ...
    /**
     * Sets volumes
     * @param \UniversityOfAdelaide\OpenShift\Model\V1Volume[] $volumes Volumes defines the collection of Volume to inject into the pod.
     * @return $this
     */
