 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1LimitRangeItem implements ArrayAccess
{
    ...
    /**
     * Sets default
     * @param map[string,\UniversityOfAdelaide\OpenShift\Model\ResourceQuantity] $default Default resource requirement limit value by resource name if resource limit is omitted.
     * @return $this
     */
    ...
    /**
     * Sets max
     * @param map[string,\UniversityOfAdelaide\OpenShift\Model\ResourceQuantity] $max Max usage constraints on this kind by resource name.
     * @return $this
     */
    ...
    /**
     * Sets min
     * @param map[string,\UniversityOfAdelaide\OpenShift\Model\ResourceQuantity] $min Min usage constraints on this kind by resource name.
     * @return $this
     */
