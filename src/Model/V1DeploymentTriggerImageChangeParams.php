...
/**
 * V1DeploymentTriggerImageChangeParams Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1DeploymentTriggerImageChangeParams implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.DeploymentTriggerImageChangeParams';
    ...
    /**
     * Sets automatic
     * @param bool $automatic Automatic means that the detection of a new tag value should result in an image update inside the pod template.
     * @return $this
     */
    ...
    /**
     * Sets from
     * @param \UniversityOfAdelaide\OpenShift\Model\V1ObjectReference $from From is a reference to an image stream tag to watch for changes. From.Name is the only required subfield - if From.Namespace is blank, the namespace of the current deployment trigger will be used.
     * @return $this
     */
