 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1NFSVolumeSource implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['server'] === null) {
            $invalid_properties[] = "'server' can't be null";
        }
    ...
    /**
     * Sets path
     * @param string $path Path that is exported by the NFS server. More info: http://kubernetes.io/docs/user-guide/volumes#nfs
     * @return $this
     */
    ...
    /**
     * Sets server
     * @param string $server Server is the hostname or IP address of the NFS server. More info: http://kubernetes.io/docs/user-guide/volumes#nfs
     * @return $this
     */
