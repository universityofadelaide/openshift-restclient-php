 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1APIGroupList implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'apiVersion' => 'string',
        'groups' => '\UniversityOfAdelaide\OpenShift\Model\V1APIGroup[]',
        'kind' => 'string'
    ];
    ...
    /**
     * Sets groups
     * @param \UniversityOfAdelaide\OpenShift\Model\V1APIGroup[] $groups groups is a list of APIGroup.
     * @return $this
     */
