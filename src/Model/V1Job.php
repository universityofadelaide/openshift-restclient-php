 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1Job implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.Job';
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V1JobSpec',
        'status' => '\UniversityOfAdelaide\OpenShift\Model\V1JobStatus'
    ];
    ...
    /**
     * Gets spec
     * @return \UniversityOfAdelaide\OpenShift\Model\V1JobSpec
     */
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V1JobSpec $spec Spec is a structure defining the expected behavior of a job. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \UniversityOfAdelaide\OpenShift\Model\V1JobStatus
     */
    ...
    /**
     * Sets status
     * @param \UniversityOfAdelaide\OpenShift\Model\V1JobStatus $status Status is a structure describing current status of a job. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
     * @return $this
     */
