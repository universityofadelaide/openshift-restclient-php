...
/**
 * V1beta1ThirdPartyResourceList Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ThirdPartyResourceList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.ThirdPartyResourceList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\UniversityOfAdelaide\OpenShift\Model\V1beta1ThirdPartyResource[]',
        'kind' => 'string',
    ...
    /**
     * Sets items
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1ThirdPartyResource[] $items Items is the list of ThirdPartyResources.
     * @return $this
     */
