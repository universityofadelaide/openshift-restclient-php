...
/**
 * V1DeploymentRequest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1DeploymentRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.DeploymentRequest';
    ...
    protected static $setters = [
        ...
        'excludeTriggers' => 'setExcludeTriggers',
        'force' => 'setForce',
        'kind' => 'setKind',
        'latest' => 'setLatest',
        'name' => 'setName'
    ...
    protected static $getters = [
        ...
        'excludeTriggers' => 'getExcludeTriggers',
        'force' => 'getForce',
        'kind' => 'getKind',
        'latest' => 'getLatest',
        'name' => 'getName'
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['excludeTriggers'] = isset($data['excludeTriggers']) ? $data['excludeTriggers'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['force'] === null) {
            $invalid_properties[] = "'force' can't be null";
        }
        if ($this->container['latest'] === null) {
            $invalid_properties[] = "'latest' can't be null";
        }
    ...
    /**
     * Gets excludeTriggers
     * @return string[]
     */
    public function getExcludeTriggers()
    {
        return $this->container['excludeTriggers'];
    }

    /**
     * Sets excludeTriggers
     * @param string[] $excludeTriggers ExcludeTriggers instructs the instantiator to avoid processing the specified triggers. This field overrides the triggers from latest and allows clients to control specific logic. This field is ignored if not specified.
     * @return $this
     */
    public function setExcludeTriggers($excludeTriggers)
    {
        $this->container['excludeTriggers'] = $excludeTriggers;
    ...
    /**
     * Sets force
     * @param bool $force Force will try to force a new deployment to run. If the deployment config is paused, then setting this to true will return an Invalid error.
     * @return $this
     */
    ...
    /**
     * Sets latest
     * @param bool $latest Latest will update the deployment config with the latest state from all triggers.
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name Name of the deployment config for requesting a new deployment.
     * @return $this
     */
