...
/**
 * V1TCPSocketAction Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1TCPSocketAction implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.TCPSocketAction';
    ...
    /**
     * Sets port
     * @param \UniversityOfAdelaide\OpenShift\Model\IntstrIntOrString $port Number or name of the port to access on the container. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME.
     * @return $this
     */
