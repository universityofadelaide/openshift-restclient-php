...
/**
 * V1DeploymentConfigRollback Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1DeploymentConfigRollback implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.DeploymentConfigRollback';
    ...
    protected static $swaggerTypes = [
        ...
        'kind' => 'string',
        'name' => 'string',
        'spec' => '\UniversityOfAdelaide\OpenShift\Model\V1DeploymentConfigRollbackSpec',
    ...
    /**
     * Sets name
     * @param string $name Name of the deployment config that will be rolled back.
     * @return $this
     */
    ...
    /**
     * Gets spec
     * @return \UniversityOfAdelaide\OpenShift\Model\V1DeploymentConfigRollbackSpec
     */
    ...
    /**
     * Sets spec
     * @param \UniversityOfAdelaide\OpenShift\Model\V1DeploymentConfigRollbackSpec $spec Spec defines the options to rollback generation.
     * @return $this
     */
     ...
     * @param map[string,string] $updated_annotations UpdatedAnnotations is a set of new annotations that will be added in the deployment config.
     * @return $this
     */
