...
class CoreApi
{
     ...
     * @return \UniversityOfAdelaide\OpenShift\Model\V1APIVersions
     */
    public function getCoreAPIVersions()
    {
        list($response) = $this->getCoreAPIVersionsWithHttpInfo();
        return $response;
    }

    /**
     * Operation getCoreAPIVersionsWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     * @return array of \UniversityOfAdelaide\OpenShift\Model\V1APIVersions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCoreAPIVersionsWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/api/";
        $httpBody = '';
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\UniversityOfAdelaide\OpenShift\Model\V1APIVersions',
                '/api/'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\UniversityOfAdelaide\OpenShift\Model\V1APIVersions', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\UniversityOfAdelaide\OpenShift\Model\V1APIVersions', $e->getResponseHeaders());
