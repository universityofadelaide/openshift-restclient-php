...
/**
 * OauthOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class OauthOpenshiftIoApi
{
    ...
    /**
     * Operation getOauthOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getOauthOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getOauthOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getOauthOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/oauth.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
