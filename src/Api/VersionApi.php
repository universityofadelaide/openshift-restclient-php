...
class VersionApi
{
     ...
     * @return \UniversityOfAdelaide\OpenShift\Model\VersionInfo
     */
    public function getCodeVersion()
    {
        list($response) = $this->getCodeVersionWithHttpInfo();
        return $response;
    }

    /**
     * Operation getCodeVersionWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     * @return array of \UniversityOfAdelaide\OpenShift\Model\VersionInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCodeVersionWithHttpInfo()
    {
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\UniversityOfAdelaide\OpenShift\Model\VersionInfo', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\UniversityOfAdelaide\OpenShift\Model\VersionInfo', $e->getResponseHeaders());
