...
/**
 * ImageOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class ImageOpenshiftIoApi
{
    ...
    /**
     * Operation getImageOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getImageOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getImageOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getImageOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/image.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
