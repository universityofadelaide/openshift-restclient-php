...
/**
 * BuildOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class BuildOpenshiftIoApi
{
    ...
    /**
     * Operation getBuildOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getBuildOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getBuildOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getBuildOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/build.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
