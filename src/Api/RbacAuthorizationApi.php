...
/**
 * RbacAuthorizationApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class RbacAuthorizationApi
{
    ...
    {
        list($response) = $this->getRbacAuthorizationAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getRbacAuthorizationAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getRbacAuthorizationAPIGroupWithHttpInfo()
    {
        // parse inputs
