...
/**
 * UserOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class UserOpenshiftIoApi
{
    ...
    /**
     * Operation getUserOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getUserOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getUserOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getUserOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/user.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
