...
class SettingsApi
{
    ...
    {
        list($response) = $this->getSettingsAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getSettingsAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getSettingsAPIGroupWithHttpInfo()
    {
        // parse inputs
