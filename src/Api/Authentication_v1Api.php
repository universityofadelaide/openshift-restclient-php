...
class Authentication_v1Api
{
    ...
    public function createAuthenticationV1TokenReviewWithHttpInfo($body, $pretty = null)
    {
        ...
        $httpBody = '';
        $multipart = false;
        $returnType = '\UniversityOfAdelaide\OpenShift\Model\V1TokenReview';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\UniversityOfAdelaide\OpenShift\Model\V1TokenReview', $e->getResponseHeaders());
