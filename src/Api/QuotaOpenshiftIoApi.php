...
/**
 * QuotaOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class QuotaOpenshiftIoApi
{
    ...
    /**
     * Operation getQuotaOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getQuotaOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getQuotaOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getQuotaOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/quota.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
