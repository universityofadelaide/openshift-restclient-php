...
class ApisApi
{
    ...
    public function getAPIVersionsWithHttpInfo()
    {
        ...
        $httpBody = '';
        $multipart = false;
        $returnType = '\UniversityOfAdelaide\OpenShift\Model\V1APIGroupList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\UniversityOfAdelaide\OpenShift\Model\V1APIGroupList', $e->getResponseHeaders());
