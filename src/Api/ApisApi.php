...
class ApisApi
{
     ...
     * @return \UniversityOfAdelaide\OpenShift\Model\V1APIGroupList
     */
    public function getAPIVersions()
    {
        list($response) = $this->getAPIVersionsWithHttpInfo();
        return $response;
    }
     ...
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     * @return array of \UniversityOfAdelaide\OpenShift\Model\V1APIGroupList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAPIVersionsWithHttpInfo()
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\UniversityOfAdelaide\OpenShift\Model\V1APIGroupList', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\UniversityOfAdelaide\OpenShift\Model\V1APIGroupList', $e->getResponseHeaders());
