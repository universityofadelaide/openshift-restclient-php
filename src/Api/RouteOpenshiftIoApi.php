...
/**
 * RouteOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class RouteOpenshiftIoApi
{
    ...
    /**
     * Operation getRouteOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getRouteOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getRouteOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getRouteOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/route.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
