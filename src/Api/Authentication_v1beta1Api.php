...
/**
 * Authentication_v1beta1Api Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class Authentication_v1beta1Api
{
    ...
    /**
     * Operation createAuthenticationV1beta1TokenReview
     *
     * 
     *
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReview $body  (required)
     ...
     * @return \UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReview
     */
    public function createAuthenticationV1beta1TokenReview($body, $pretty = null)
    {
        list($response) = $this->createAuthenticationV1beta1TokenReviewWithHttpInfo($body, $pretty);
        return $response;
    }

    /**
     * Operation createAuthenticationV1beta1TokenReviewWithHttpInfo
     *
     * 
     *
     * @param \UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReview $body  (required)
     * @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     * @return array of \UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReview, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAuthenticationV1beta1TokenReviewWithHttpInfo($body, $pretty = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling createAuthenticationV1beta1TokenReview');
        }
        // parse inputs
        $resourcePath = "/apis/authentication.k8s.io/v1beta1/tokenreviews";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReview',
                '/apis/authentication.k8s.io/v1beta1/tokenreviews'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReview', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReview', $e->getResponseHeaders());
    ...
    /**
     * Operation getAuthenticationV1beta1APIResources
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
    ...
    {
        list($response) = $this->getAuthenticationV1beta1APIResourcesWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAuthenticationV1beta1APIResourcesWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getAuthenticationV1beta1APIResourcesWithHttpInfo()
    {
        // parse inputs
