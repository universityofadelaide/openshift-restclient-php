...
/**
 * AppsOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class AppsOpenshiftIoApi
{
    ...
    /**
     * Operation getAppsOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getAppsOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAppsOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getAppsOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/apps.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
