...
/**
 * ProjectOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class ProjectOpenshiftIoApi
{
    ...
    /**
     * Operation getProjectOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getProjectOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getProjectOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getProjectOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/project.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
