...
/**
 * NetworkOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class NetworkOpenshiftIoApi
{
    ...
    /**
     * Operation getNetworkOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getNetworkOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getNetworkOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getNetworkOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/network.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
