...
/**
 * AuthorizationOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuthorizationOpenshiftIoApi
{
    /**
     * API Client
     *
     ...
     *
     * @return AuthorizationOpenshiftIoApi
     */
    ...
    /**
     * Operation getAuthorizationOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getAuthorizationOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAuthorizationOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getAuthorizationOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/authorization.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\UniversityOfAdelaide\OpenShift\Model\V1APIGroup', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\UniversityOfAdelaide\OpenShift\Model\V1APIGroup', $e->getResponseHeaders());
