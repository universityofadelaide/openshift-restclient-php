...
class AuthenticationApi
{
    ...
    {
        list($response) = $this->getAuthenticationAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAuthenticationAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getAuthenticationAPIGroupWithHttpInfo()
    {
        // parse inputs
