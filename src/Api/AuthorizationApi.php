...
class AuthorizationApi
{
    ...
    {
        list($response) = $this->getAuthorizationAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAuthorizationAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getAuthorizationAPIGroupWithHttpInfo()
    {
        // parse inputs
