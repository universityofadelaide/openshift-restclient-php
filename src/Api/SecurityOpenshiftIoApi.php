...
/**
 * SecurityOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class SecurityOpenshiftIoApi
{
    ...
    /**
     * Operation getSecurityOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getSecurityOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getSecurityOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getSecurityOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/security.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
