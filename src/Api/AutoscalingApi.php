...
/**
 * AutoscalingApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class AutoscalingApi
{
    ...
    {
        list($response) = $this->getAutoscalingAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAutoscalingAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getAutoscalingAPIGroupWithHttpInfo()
    {
        // parse inputs
