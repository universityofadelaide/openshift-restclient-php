...
class OsapiApi
{
    ...
    {
        list($response) = $this->getOsapiVersionWithHttpInfo();
        return $response;
    }

    /**
     * Operation getOsapiVersionWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getOsapiVersionWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/osapi/";
        $httpBody = '';
