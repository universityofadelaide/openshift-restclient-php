...
/**
 * TemplateOpenshiftIoApi Class Doc Comment
 *
 * @category Class
 * @package  UniversityOfAdelaide\OpenShift
 * @author   Swagger Codegen team
...
class TemplateOpenshiftIoApi
{
    ...
    /**
     * Operation getTemplateOpenshiftIoAPIGroup
     *
     * 
     *
    ...
    {
        list($response) = $this->getTemplateOpenshiftIoAPIGroupWithHttpInfo();
        return $response;
    }

    /**
     * Operation getTemplateOpenshiftIoAPIGroupWithHttpInfo
     *
     * 
     *
     * @throws \UniversityOfAdelaide\OpenShift\ApiException on non-2xx response
     ...
     */
    public function getTemplateOpenshiftIoAPIGroupWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/apis/template.openshift.io/";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
