...
**spec** | [**\UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReviewSpec**](V1beta1TokenReviewSpec.md) | Spec holds information about the request being evaluated | 
**status** | [**\UniversityOfAdelaide\OpenShift\Model\V1beta1TokenReviewStatus**](V1beta1TokenReviewStatus.md) | Status is filled in by the server and indicates whether the request can be authenticated. | [optional] 
