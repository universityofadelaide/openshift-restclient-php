...
**items** | [**\UniversityOfAdelaide\OpenShift\Model\V1Secret[]**](V1Secret.md) | Items is a list of secret objects. More info: http://kubernetes.io/docs/user-guide/secrets | 
