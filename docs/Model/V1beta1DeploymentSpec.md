...
**rollback_to** | [**\UniversityOfAdelaide\OpenShift\Model\V1beta1RollbackConfig**](V1beta1RollbackConfig.md) | The config this deployment is rolling back to. Will be cleared after rollback is done. | [optional] 
