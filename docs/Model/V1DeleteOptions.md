...
**preconditions** | [**\UniversityOfAdelaide\OpenShift\Model\V1Preconditions**](V1Preconditions.md) | Must be fulfilled before a deletion is carried out. If not possible, a 409 Conflict status will be returned. | [optional] 
