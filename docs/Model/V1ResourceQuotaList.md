...
**items** | [**\UniversityOfAdelaide\OpenShift\Model\V1ResourceQuota[]**](V1ResourceQuota.md) | Items is a list of ResourceQuota objects. More info: http://releases.k8s.io/HEAD/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota | 
