...
**items** | [**\UniversityOfAdelaide\OpenShift\Model\V1beta1ReplicaSet[]**](V1beta1ReplicaSet.md) | List of ReplicaSets. More info: http://kubernetes.io/docs/user-guide/replication-controller | 
