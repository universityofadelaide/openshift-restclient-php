...
**role_ref** | [**\UniversityOfAdelaide\OpenShift\Model\V1beta1RoleRef**](V1beta1RoleRef.md) | RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. | 
**subjects** | [**\UniversityOfAdelaide\OpenShift\Model\V1beta1Subject[]**](V1beta1Subject.md) | Subjects holds references to the objects the role applies to. | 
