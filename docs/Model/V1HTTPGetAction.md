...
**http_headers** | [**\UniversityOfAdelaide\OpenShift\Model\V1HTTPHeader[]**](V1HTTPHeader.md) | Custom headers to set in the request. HTTP allows repeated headers. | [optional] 
