...
**spec** | [**\UniversityOfAdelaide\OpenShift\Model\V1RouteSpec**](V1RouteSpec.md) | spec is the desired state of the route | 
**status** | [**\UniversityOfAdelaide\OpenShift\Model\V1RouteStatus**](V1RouteStatus.md) | status is the current state of the route | 
