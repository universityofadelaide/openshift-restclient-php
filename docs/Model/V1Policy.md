...
**last_modified** | [**\UniversityOfAdelaide\OpenShift\Model\V1Time**](V1Time.md) | LastModified is the last time that any part of the Policy was created, updated, or deleted | 
**metadata** | [**\UniversityOfAdelaide\OpenShift\Model\V1ObjectMeta**](V1ObjectMeta.md) | Standard object&#39;s metadata. | [optional] 
**roles** | [**\UniversityOfAdelaide\OpenShift\Model\V1NamedRole[]**](V1NamedRole.md) | Roles holds all the Roles held by this Policy, mapped by Role.Name | 
