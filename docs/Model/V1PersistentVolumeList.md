...
**items** | [**\UniversityOfAdelaide\OpenShift\Model\V1PersistentVolume[]**](V1PersistentVolume.md) | List of persistent volumes. More info: http://kubernetes.io/docs/user-guide/persistent-volumes | 
