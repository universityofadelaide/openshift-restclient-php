...
------------ | ------------- | ------------- | -------------
**capabilities** | [**\UniversityOfAdelaide\OpenShift\Model\V1Capabilities**](V1Capabilities.md) | The capabilities to add/drop when running containers. Defaults to the default set of capabilities granted by the container runtime. | [optional] 
