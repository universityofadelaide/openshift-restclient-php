...
**items** | [**\UniversityOfAdelaide\OpenShift\Model\V1DeprecatedDownwardAPIVolumeFile[]**](V1DeprecatedDownwardAPIVolumeFile.md) | Items is a list of downward API volume file | [optional] 
