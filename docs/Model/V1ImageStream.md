...
**spec** | [**\UniversityOfAdelaide\OpenShift\Model\V1ImageStreamSpec**](V1ImageStreamSpec.md) | Spec describes the desired state of this stream | 
**status** | [**\UniversityOfAdelaide\OpenShift\Model\V1ImageStreamStatus**](V1ImageStreamStatus.md) | Status describes the current state of this stream | [optional] 
