...
**spec** | [**\UniversityOfAdelaide\OpenShift\Model\V1ProjectSpec**](V1ProjectSpec.md) | Spec defines the behavior of the Namespace. | [optional] 
**status** | [**\UniversityOfAdelaide\OpenShift\Model\V1ProjectStatus**](V1ProjectStatus.md) | Status describes the current status of a Namespace | [optional] 
