...
**metadata** | [**\UniversityOfAdelaide\OpenShift\Model\V1ObjectMeta**](V1ObjectMeta.md) | metadata for EgressNetworkPolicy | [optional] 
**spec** | [**\UniversityOfAdelaide\OpenShift\Model\V1EgressNetworkPolicySpec**](V1EgressNetworkPolicySpec.md) | spec is the specification of the current egress network policy | 
