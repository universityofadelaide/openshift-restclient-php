...
**client_name** | **string** | ClientName references the client that created this authorization | [optional] 
...
**user_name** | **string** | UserName is the user name that authorized this client | [optional] 
**user_uid** | **string** | UserUID is the unique UID associated with this authorization. UserUID and UserName must both match for this authorization to be valid. | [optional] 
