...
**delete_options** | [**\UniversityOfAdelaide\OpenShift\Model\V1DeleteOptions**](V1DeleteOptions.md) | DeleteOptions may be provided | [optional] 
**kind** | **string** | Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds | [optional] 
**metadata** | [**\UniversityOfAdelaide\OpenShift\Model\V1ObjectMeta**](V1ObjectMeta.md) | ObjectMeta describes the pod that is being evicted. | [optional] 
