...
> \UniversityOfAdelaide\OpenShift\Model\V1WatchEvent watchCertificatesV1beta1CertificateSigningRequestList($fieldSelector, $labelSelector, $pretty, $resourceVersion, $timeoutSeconds, $watch)
