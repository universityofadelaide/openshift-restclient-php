...
> \UniversityOfAdelaide\OpenShift\Model\V1Status deleteAutoscalingV1NamespacedHorizontalPodAutoscaler($name, $namespace, $body, $pretty, $gracePeriodSeconds, $orphanDependents, $propagationPolicy)
