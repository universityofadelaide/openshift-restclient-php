...
> \UniversityOfAdelaide\OpenShift\Model\V1WatchEvent watchUserOpenshiftIoV1GroupList($fieldSelector, $labelSelector, $pretty, $resourceVersion, $timeoutSeconds, $watch)
